...
if (isset($_POST["submit"])){
	...
	$val_cantidad=comp_Cantidad($id_prod,$cant,conexion());	//variable que nos sevira para comprobar suficientes cantidades.
	
	if(empty($fech_comp)){	//Si no ha seleccionado fecha, cogera el dia que ha hecho la compra.
