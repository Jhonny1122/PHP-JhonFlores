<?php
	...
	if(isset($_POST["comprar"])){
		...
		$pago_ok=false;
		/*Comprobamos que el numero de pago*/
		$bien_letras=false;
		...
		/*Si el numero de pago esta bien se hace lo siguiente*/
		if($pago_ok == true ){
			...
			$sHTML .= 'Precio total: ' . $preciofinal . "<br>";
			
			if($ok_datos && $ok_cant){
				
				unset($_SESSION["carrito"]);
				
				$sHTML .= "Compra Realizada con exito" . "<br>";
			}
		}
	}
